...
class TestAbsLoss(unittest.TestCase):
    ...
    def test_error(self):
        ...
        # call the `abs_loss` function
        t.call("abs_loss")
        # check that executing the test gives you error code 36
        t.execute(code=36)
